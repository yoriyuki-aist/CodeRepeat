...
static void appendRaw(std::ofstream &out, unsigned ch) {
    out << static_cast<char>(ch);
}

static void appendHex(std::ofstream &out, unsigned ch) {
...
void write_escaped_string(std::ofstream &out, const std::string &str) {
    out << '"';
